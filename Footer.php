        ...
        <div class="col-12 d-flex flex-wrap mt-3" style="background-color:#222f3e; color: white; font-family: 'Asap', sans-serif;">
            ...
            <div class="col-12 col-md-6 p-3">
                ...
                <div class="col-12 d-flex justify-between">
                    ...
                    <a href="#" class="w-25"><i class="bi bi-instagram fs-2" style="background: linear-gradient(45deg, #f09433, #e6683c, #dc2743, #cc2366, #bc1888);
                            -webkit-background-clip: text;color: transparent;"></i></a>
                </div>
                <div class="col-12">
